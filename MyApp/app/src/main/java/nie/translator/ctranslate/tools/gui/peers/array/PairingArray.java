...
package nie.translator.ctranslate.tools.gui.peers.array;

import android.content.Context;
import androidx.annotation.NonNull;
import java.util.Collection;
import nie.translator.ctranslate.R;
import nie.translator.ctranslate.tools.gui.WeightArray;
import nie.translator.ctranslate.tools.gui.WeightElement;
import nie.translator.ctranslate.tools.gui.peers.GuiPeer;
import nie.translator.ctranslate.tools.gui.peers.Header;
