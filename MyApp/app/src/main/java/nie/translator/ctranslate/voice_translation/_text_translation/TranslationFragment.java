package nie.translator.ctranslate.voice_translation._text_translation;
...
import nie.translator.ctranslate.tools.gui.GuiTools;
...
public class TranslationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        toolbarContainer = view.findViewById(R.id.toolbactranslateContainer);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = activity.findViewById(R.id.toolbactranslate);
