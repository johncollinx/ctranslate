...
abstract class Channel {
    ...
    @NonNull
    private Peer peer;
    private nie.translator.ctranslate.bluetooth.BluetoothMessage.SequenceNumber messageID;
    private nie.translator.ctranslate.bluetooth.BluetoothMessage.SequenceNumber dataID;
    @Nullable
    protected ArrayDeque<nie.translator.ctranslate.bluetooth.BluetoothMessage> pendingMessage;
    @Nullable
    protected ArrayDeque<nie.translator.ctranslate.bluetooth.BluetoothMessage> pendingData;
    private ArrayList<nie.translator.ctranslate.bluetooth.BluetoothMessage> receivingMessages = new ArrayList<>();
    private ArrayList<nie.translator.ctranslate.bluetooth.BluetoothMessage> receivingData = new ArrayList<>();
    private ArrayList<nie.translator.ctranslate.bluetooth.BluetoothMessage> receivedMessages = new ArrayList<>();
    private ArrayList<nie.translator.ctranslate.bluetooth.BluetoothMessage> receivedData = new ArrayList<>();
    ...
    protected Channel(Context context, @NonNull Peer peer) {
        ...
        this.messageID= new nie.translator.ctranslate.bluetooth.BluetoothMessage.SequenceNumber(context, nie.translator.ctranslate.bluetooth.BluetoothMessage.ID_LENGTH);
        this.dataID= new nie.translator.ctranslate.bluetooth.BluetoothMessage.SequenceNumber(context, nie.translator.ctranslate.bluetooth.BluetoothMessage.ID_LENGTH);
    ...
    public void writeMessage(nie.translator.ctranslate.bluetooth.Message message, MessageCallback callback) {
        synchronized (lock) {
    ...
    public void onSubMessageWriteSuccess() {
        synchronized (lock) {
            nie.translator.ctranslate.bluetooth.BluetoothMessage subMessageSent = null;
            if (pendingMessage != null) {
                subMessageSent = pendingMessage.pollFirst();  // remove the newly sent subMessage
            }
            resetMessageTimer();
            if (subMessageSent != null && subMessageSent.getType() == nie.translator.ctranslate.bluetooth.BluetoothMessage.FINAL) {
    ...
    public void onSubDataWriteSuccess() {
        synchronized (lock) {
            nie.translator.ctranslate.bluetooth.BluetoothMessage subDataSent = null;
            if (pendingData != null) {
                subDataSent = pendingData.pollFirst();  // remove the newly sent subMessage
            }
            resetDataTimer();
            if (subDataSent != null && subDataSent.getType() == nie.translator.ctranslate.bluetooth.BluetoothMessage.FINAL) {
    ...
    @Nullable
    public nie.translator.ctranslate.bluetooth.BluetoothMessage getPendingSubMessage() {
        synchronized (lock) {
            if (pendingMessage != null) {
    ...
    @Nullable
    public nie.translator.ctranslate.bluetooth.BluetoothMessage getPendingSubData() {
        synchronized (lock) {
            if (pendingData != null) {
    ...
    public ArrayList<nie.translator.ctranslate.bluetooth.BluetoothMessage> getReceivingMessages() {
        return receivingMessages;
    }

    public ArrayList<nie.translator.ctranslate.bluetooth.BluetoothMessage> getReceivingData() {
        return receivingData;
    }

    public ArrayList<nie.translator.ctranslate.bluetooth.BluetoothMessage> getReceivedMessages() {
        return receivedMessages;
    }

    public ArrayList<nie.translator.ctranslate.bluetooth.BluetoothMessage> getReceivedData() {
        return receivedData;
    }

    public void addReceivedMessage(nie.translator.ctranslate.bluetooth.BluetoothMessage message) {
    ...
    public void addReceivedData(nie.translator.ctranslate.bluetooth.BluetoothMessage data) {
        if(data.getId().isMax()){
            receivedData.clear();
        }else{
