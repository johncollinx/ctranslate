...
public class Message implements Parcelable, Cloneable {
     ...
     */
    public ArrayDeque<nie.translator.ctranslate.bluetooth.BluetoothMessage> splitInBluetoothMessages(nie.translator.ctranslate.bluetooth.BluetoothMessage.SequenceNumber id) {
        int subDataLength = nie.translator.ctranslate.bluetooth.BluetoothConnection.SUB_MESSAGES_LENGTH - nie.translator.ctranslate.bluetooth.BluetoothMessage.TOTAL_LENGTH;
        ...
        nie.translator.ctranslate.bluetooth.BluetoothMessage.SequenceNumber sequenceNumber = new nie.translator.ctranslate.bluetooth.BluetoothMessage.SequenceNumber(context, nie.translator.ctranslate.bluetooth.BluetoothMessage.SEQUENCE_NUMBER_LENGTH);
        ArrayDeque<nie.translator.ctranslate.bluetooth.BluetoothMessage> bluetoothMessages = new ArrayDeque<>();
        while (subDataArray.peekFirst() != null) {
            byte[] subData = subDataArray.pollFirst();
            int type;
            if (subDataArray.peekFirst() == null) {
                type = nie.translator.ctranslate.bluetooth.BluetoothMessage.FINAL;
            } else {
                type = nie.translator.ctranslate.bluetooth.BluetoothMessage.NON_FINAL;
            }
            bluetoothMessages.addLast(new nie.translator.ctranslate.bluetooth.BluetoothMessage(context, id.clone(), sequenceNumber.clone(), type, subData));
